export const APP_CONSTANTS = {
	...
	ERROR_IN_EXCEL_COLUMNS: "Error in Excel Columns",
};
...
export const MONGO_CONSTANTS = {
	...
	ORDERS: {
		...
		EMPLOYEE_ID: "employeeId",
		PRODUCT_ID: "productId",
		PRODUCT_DETAILED_ID: "productDetails.productId",
		QUANTITY: "quantity",
		STATUS_ID: "statusId",
		ORDER_DETAILS_STATUS_ID: "orderDetails.statusId",
	},
	REWARDS: {
...
export const ProductExcelUploadKeys = {
	title: "Title",
	rewardPoints: "Reward Points",
	isCustomisable: "Customisable",
	productImgURL: "Image Url"
};
export const  ExpectedKeysForProductExcelUpload: string[] = [ "Title", "Reward Points", "Customisable", "Image Url" ];