export const statusMessages = {
	...
	PRODUCT_ALREADY_DEACTIVATED: "Product has been deactivated already",
	PRODUCT_ALREADY_ACTIVATED: "Product is already Active",
};
...
export const cartMessages = {
	...
	ITEM_COST_CHANGED: "The cost of this item has changed. Please remove the item to place the order.",
};
