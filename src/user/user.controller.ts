...
exports.placeOrder = async (req: Request, res: Response) => {
	...
	try {
		...
		logger.error("Error in User Controller - Place Order" + JSON.stringify(e?.message));
		const errorObject = {
...
exports.getProductsList = (req: Request, res: Response) => {
	try {
		...
		logger.warn("Fetch Products Failed - Server Error");
	}
};
...
exports.updateCart = async (req: Request, res: Response) => {
	...
	try {
		...
		logger.error(
			"Error in User Controller - Update Cart" + JSON.stringify(error?.message),
		);
	}
};
...
exports.getCart = async (req: Request, res: Response) => {
	...
	try {
		...
		logger.error("Error in User Controller - Get Cart" + JSON.stringify(error?.message));
	}
};
...
exports.getCOItems = async (req: Request, res: Response) => {
	...
	try {
		...
		logger.error(
			"Error in User Controller - Get Checkout Items" + JSON.stringify(error?.message),
		);
		sendServerErrorResponse(res);
	}
};
 ...
 exports.claimReward = async (req: Request, res: Response) => {
	...
	try {
		if(!couponCode || !secretCode) {
			logger.warn("Bad Request - Coupon Validation");
			sendResponse(
				statusMessages.BAD_REQUEST,
				statusCodes.BAD_REQUEST,
				res,
